...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            var name = parts[1];
            var type = parts[2];
            var isWeighted = parts[3].Length > 0;

            BaseGradeBook gradeBook;

            if (type == "standard") gradeBook = new StandardGradeBook(name, isWeighted);
            if (type == "ranked") gradeBook = new RankedGradeBook(name, isWeighted);
            else
            {
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Create 'Name' 'Type' 'Weighted' - Creates a new gradebook where 'Name' is the name of the gradebook and 'Type' is what type of grading it should use, and " +
